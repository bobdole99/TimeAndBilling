        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedProjectHours = table.Column<double>(type: "float", nullable: true),
                    ActualProjectHours = table.Column<double>(type: "float", nullable: true),
                    BillableHours = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "EmployeeBankings",
                columns: table => new
                {
                    EmployeeBankingID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmployeeID = table.Column<int>(type: "int", nullable: false),
                    NameOfBank = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    InstituteNumber = table.Column<int>(type: "int", nullable: false),
                    TransitNumber = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeBankings", x => x.EmployeeBankingID);
                    table.ForeignKey(
                        name: "FK_EmployeeBankings_Employees_EmployeeID",
                        column: x => x.EmployeeID,
                        principalTable: "Employees",
                        principalColumn: "EmployeeID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeBankings_EmployeeID",
                table: "EmployeeBankings",
                column: "EmployeeID");
